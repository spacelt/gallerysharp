...
using GallerySharp.Data;
using GallerySharp.Models;
using GallerySharp.Services;
using GallerySharp.Data.GalleryRepository;
using Microsoft.AspNetCore.Mvc;

namespace GallerySharp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<GalleryDbContext>((d) =>
            {
                return new GalleryDbContext(Configuration.GetConnectionString("DefaultConnection"));
            });
